...
Output `.mat` files go to `hung/data/`. Output `.png` files go to `hung/figures/` (2D/3D B-field) or `hung/figures/analytic/` (fitting error, projection).
