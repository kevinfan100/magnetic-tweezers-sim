...
%
%  Outputs:
%    hung/figures/coil1/Bvector_P1_projections_RoundFillet_l500_xsec_cyl.png   (s=25)
%    hung/figures/coil1/Bvector_P1_projections_RoundFillet_l500_xsec_cone.png  (s=10)
