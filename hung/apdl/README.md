...
```bash
# From project root, paths assume hung/ as working tree
...
For batch-running Coils 2-6, use the shell scripts in `hung/scripts/run/`:
...
See `hung/scripts/run/README.md` for details and `hung/scripts/run/variants/` for earlier versions.
