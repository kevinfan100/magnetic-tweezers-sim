...
`hung/docs/hexapole-build-workflow.md`
...
> 4. 下層傾斜角（°）
>
> 詳細流程文檔在 `hung/docs/hexapole-build-workflow.md`。
...
5. **技術細節（APDL 陷阱、材料、coil 設定等）見 `hung/docs/` 和 `.claude/rules/hung-docs.md`**，此處不重複
